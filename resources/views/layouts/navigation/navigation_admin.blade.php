    ...
    <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <div class="collapse" id="collapseAktivitas">
                ...
                <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-handshake me-2 text-dark"></i> Kunjungan&Interaksi</a>
            </div>
            <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-inbox me-2 text-dark"></i> Feedback Masuk</a>
            ...
            <div class="collapse" id="collapseLaporan">
                ...
                <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-bolt me-2 text-dark"></i> Pemakaian Daya</a>
